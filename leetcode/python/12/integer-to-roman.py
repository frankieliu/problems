...
class Solution:
    def intToRoman(self, num):
        ...
        :rtype: str
        """
        return self.intToRoman0(num, 0)

    def intToRoman0(self, num, i):
        if num == 0:
            return ""
        if ds[i] > num:
            return self.intToRoman0(num, i+1)
        return d[ds[i]] + self.intToRoman0(num-ds[i], i)
