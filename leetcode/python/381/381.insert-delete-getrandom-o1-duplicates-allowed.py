...
class RandomizedCollection:
    ...
    This algo is very clean:

    1. when adding always at to the end of the list

    2. when deleting always move item at the end of the list into the deleted position

    3. how to find location in list?
       keep a dictionary where the key is the number and the value is a
       "set" of positions in the array, it doesn't matter which index you choose
       to discard, any position is as good another.
