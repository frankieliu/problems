...
#include "friends-of-appropriate-ages.hpp"
...
TEST(Leetcode, friendsOfAppropriateAges_825) {
    Solution s;
    vector<int> a={16,16};
    EXPECT_EQ(2, s.numFriendRequests(a));
    vector<int> b={16,17,18};
    EXPECT_EQ(2, s.numFriendRequests(b));
    vector<int> c={20,30,100,110,120};
    EXPECT_EQ(3, s.numFriendRequests(c));
}
